...
5.	__Configure Git with your Name and Email__
   ...
   * [http ://help.github.com/articles/setting-your-email-in-git](https://help.github.com/articles/setting-your-email-in-git)
   * [https://help.github.com/articles/setting-your-username-in-git](ttps://help.github.com/articles/setting-your-username-in-git)

6.	__Install RVM with Ruby 2.1.3__
	* OSX comes with Ruby 1.8.7 out of the box. However, for this class we want to use Ruby 2.1.3.
	...
	* We will use RVM to install Ruby 2.1.3, and then set it as the default Ruby.
	* To install Ruby 2.1.3 with RVM, run this command:
	  	* ```\curl -L https://get.rvm.io | bash -s stable --ruby```
	* Now set Ruby 2.1.3 as your default Ruby build:
...
8.	__Make sure the latest versions of RVM and Ruby were installed__
	* To verify that you have the latest RVM and Ruby, run the commands below:
		...
		* 	For Ruby: ```ruby -v``` (you should get ruby 2.1.3 or higher)
...
2. __Download Ubuntu Linux__
  ...
  * Version 14.04 is probably preferable but 12.04 is also fine.
